...
public class SchemaBuilder {
    ...
    public static void populateWithSampleData(final DataSource dataSource) {
        ...
        bookDao.createBook(new Book("978-1-84983-109-3", "Serpent", 1, 2, 1, 1, 1, 474, ""));
        bookDao.createBook(new Book("978-1-84739-971-7", "Blue Gold", 1, 2, 2, 1, 2, 378, ""));
        bookDao.createBook(new Book("0-140-29736-7", "Fire Ice", 1, 2, 3, 1, 1, 434, ""));
        bookDao.close();
    }
}
